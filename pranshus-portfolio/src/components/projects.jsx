		...
		return(
			<div className="container mt-5 pt-5 pb-5" data-aos="fade" data-aos-easing="ease-in-out" data-aos-duration="750">
				...
				<div className="container row row-col-1">
					<div className="card m-2 shadow" style={{ minWidth: '15rem' }} data-aos="fade" data-aos-easing="ease-in-out" data-aos-duration="750">
				...
				<p className="pt-5 card-text lead gray-text pb-5">
