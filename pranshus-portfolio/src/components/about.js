		...
		<div className="text-center container">
			<div className="flex flex-wrap justify-center align-top">
				<div className={cardClass}>
					<h3 className="text-2xl mb-2 pt-6">ABOUT ME</h3>
				...
				<div className={cardClass}>
					...
					<h5 className="text-xl mb-2">Web Development</h5>
					<p className="text-gray-800 mb-4">I have experience building websites using HTML, CSS, Sass, JavaScript, React and, the python-framework Django.</p>
					<h5 className="text-xl mb-2">Known Languages</h5>
